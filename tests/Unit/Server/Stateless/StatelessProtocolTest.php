...
class StatelessProtocolTest extends TestCase
{
    ...
    #[TestDox('an extension with a malformed identifier is refused at build time')]
    public function testMalformedExtensionIdentifierIsRefused(): void
    {
        $this->expectException(LogicException::class);
        $this->expectExceptionMessageMatches('/has no prefix/');

        Server::builder()
            ->setServerInfo('test-server', '1.0.0')
            ->enableExtension(new ThingExtension('things'));
    }
